...
public class ScreenCreateCust extends JFrame {
    ...
    private final ArrayList<String> choiceStatus;
    ...
    public ScreenCreateCust(int idC0) throws SQLException {
        initComponents();
        ArrayList<Component> fieldList = new ArrayList<>(fieldsTabOrder());
        this.idC = idC0;
    ...
    /**
     * fieldsTabOrder retrieve all the Component with name different of null and
     * sort them by order of access
     *
     * @return a list of all the component that we want access with the
     * tabulation sort by order of access
     */
    public ArrayList<Component> fieldsTabOrder() {
        // 
        Component[] backPanel = jPanel1.getComponents();
        ArrayList<String> fieldNames = new ArrayList<>();
        ArrayList<Component> fieldList = new ArrayList<>();
        // For each Component the name is retrieve if it's not  null and the name is add to a new list
        for (Component field : backPanel) {
            if (field.getName() != null) {
                fieldNames.add(field.getName());
                System.out.println("back = " + field.getName());
            }
        }
        //List sort 
        fieldNames.sort(Comparator.naturalOrder());
        //  each element with a name is add in order to a new list
