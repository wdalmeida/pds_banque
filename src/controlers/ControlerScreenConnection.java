...
import serialisation.JsonEncoding;
import server.ClientJavaSelect;
import views.ScreenHome;
import views.Window;

public class ControlerScreenConnection implements ActionListener {
    ...
    public ControlerScreenConnection(Window fen0, JTextField identifiant0, JPasswordField password0, JLabel labelError) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (!"".equals(identifiant.getText().trim()) && !"".equals(password.getText().trim())) {
            try {
                ...
                Logger.getLogger(ControlerScreenConnection.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
