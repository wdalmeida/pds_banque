...
import static serialisation.JsonEncoding.encodageCustomer;
import server.ClientJavaInsert;

/**
 *
 * @author florent
 */
public class ControlerScreenCreateCust implements ActionListener {
    ...
    public ControlerScreenCreateCust(ScreenCreateCust scc0, int idConsultant0, JButton back, JButton submit) {
    ...
    public ControlerScreenCreateCust(ScreenCreateCust scc0, JComboBox title0, JTextField lastName0, JTextField firstName0, JXDatePicker birthday0, JTextField nationality0, JTextField phoneNumber0, JTextField email0, JCheckBox owner0, JTextField salary0, JComboBox status0, JTextField street0, JTextField city0, JTextField postalCode0, int idC0, JButton btnSubmit0, JButton btnBack0) {
        ...
        if (e.getSource() == btnSubmit) {
            try {
                ...
                /*try {
                 ...
                 Logger.getLogger(ControlerScreenCreateCust.class.getName()).log(Level.SEVERE, null, ex);
                 }*/
