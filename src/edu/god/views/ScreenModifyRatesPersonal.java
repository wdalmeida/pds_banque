 ...
 * @author Coline
 */
public class ScreenModifyRatesPersonal extends javax.swing.JFrame {

    /**
     * Creates new form ScreenModifyRates
     */
    public ScreenModifyRatesPersonal() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScreenModifyRatesPersonal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScreenModifyRatesPersonal().setVisible(true);
            }
        });
    }
