...
public class ScreenModifyRatesRepurchase extends javax.swing.JFrame {
     ...
     */
    public ScreenModifyRatesRepurchase() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScreenModifyRatesRepurchase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScreenModifyRatesRepurchase().setVisible(true);
            }
        });
    }
